...
def test_positive_scenario_login(driver):
    ...
    login_page.click_on_button_vorod_login()
    login_page.send_data_in_input_username_login()
    login_page.send_data_in_input_password_login()
    login_page.click_on_button_vorod_after_fill_login()
    time.sleep(25)
