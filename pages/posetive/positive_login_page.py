...
class Positive_login_page(BaseActionLocator):
    ...
    def click_on_button_vorod_login(self):
        self.click((By.XPATH, "//span[contains(.,'ورود')]"))

    def send_data_in_input_username_login(self):
        self.send_keys((By.ID, 'username'), '09104652470')

    def send_data_in_input_password_login(self):
        self.send_keys((By.ID, 'password'), 'root..root007')

    def click_on_button_vorod_after_fill_login(self):
